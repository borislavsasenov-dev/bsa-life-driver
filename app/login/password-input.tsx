  ...
  return (
    <div className="relative mt-1">
      <input
        ...
        className="w-full rounded-lg border border-neutral-300 px-3 py-2 pr-10 text-sm text-neutral-900 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
      />
      <button
        type="button"
